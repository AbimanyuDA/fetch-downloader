...
export default function MainApp() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#090a0f] text-gray-100 selection:bg-indigo-600 selection:text-white">
      <Navbar />

      <main className="flex-1 relative bg-radial-gradient">
        {/* Hero Container */}
